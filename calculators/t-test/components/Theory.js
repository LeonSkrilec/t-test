  ...
  return (
    <>
      ...
      <Typography variant="body1" paragraph>
        T-test spada v družino inferenčne statistike t.j. veja statistike, ki se ukvarja s{' '}
      ...
      {isReadingMore && (
        <>
          ...
          <Typography variant="body1" paragraph>
            Recimo, da želimo preveriti, ali ima kovanec res 50% možnosti, da pade na stran grba. V ta namen bi
            postavili ničelno hipotezo, ki pravi da je verjetnost res 50% in alternativno, ki pravi, da je verjetnost
            različna od 50%:
          </Typography>
          <Typography variant="body1" paragraph>
          ...
          <Typography variant="body1" paragraph>
            Nato vzamemo vzorec 100 metov kovanca (N = 100) in preverimo pravilnost ničelne hipoteze. Če bi dobili npr.
            40 metov na stran glave in 60 metov na stran grba bi že lahko malo podvomili v pravilnost ničelne domneve.{' '}
          </Typography>
          <Typography variant="body1" paragraph>
            Če pa bi npr. dobili 52 metov na stran glave in 48 metov na stran grba pa zaključek, da ničelna hipoteza ne
            drži, ne bi bil tako preprost, saj je kovanec še vedno lahko pošten, vendar je ravno v tem vzorcu produciral
            tak rezultat.{' '}
          </Typography>
          <Typography variant="body1" paragraph>
            Lepota statistike je v tem, da lahko, z določeno stopnjo tveganja, računsko dokažemo, kdaj je vzorčna
            statistika res značilna tudi na populaciji in kdaj je le posledica naključne izbire enot v vzorec.
          </Typography>
          <Typography variant="h5">Interpretacija</Typography>
          <Typography variant="body1" paragraph>
            T-test nam vrne testno statistiko <strong>t</strong>, ki pa sama po sebi še ni tako pomembna za
            interpretacijo. Načeloma pa velja:
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            Uporabna za interpretacijo pa je vrednost <strong>p</strong>, ki jo dobimo tako, da jo razberemo iz tabele
            Studentove t-porazdelitve, možno pa jo je tudi matematično izračunati. Vrednost p imenujemo natančna stopnja
            značilnosti (tudi signifikanca) in nam pove, kolikšna je verjetnost, da pri dani ničelni hipotezi dobimo
            tako vzorčno povprečje ali delež kot smo ga dobili. Če je ta verjetnost dovolj majhna lahko zaključimo, da
            je zelo malo verjetno, da bi dobili takšno vzorčno statistiko, ob predpostavki, da naša ničelna hipoteza
            drži. Tako lahko podvomimo v pravilnost ničelne hipoteze in jo zavrnemo.
          </Typography>
          <Box mt={3}>
